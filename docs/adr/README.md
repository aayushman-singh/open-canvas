...
| 0050 | Layout primitives: fluid type, anchor ids, site-level scroll behaviour | Accepted | [`docs/adr/0050-layout-primitives-fluid-type-anchor-ids-scroll-padding.md`](0050-layout-primitives-fluid-type-anchor-ids-scroll-padding.md) |
| 0051 | Action expressiveness: rich labels, icon registry, copy behaviour, container links | Accepted | [`docs/adr/0051-action-expressiveness-rich-labels-icons-copy-container-links.md`](0051-action-expressiveness-rich-labels-icons-copy-container-links.md) |
| 0052 | Tabs as a `TabsElement` with embedded panels | Accepted | [`docs/adr/0052-tabs-as-element-with-embedded-panels.md`](0052-tabs-as-element-with-embedded-panels.md) |
