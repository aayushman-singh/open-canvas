...
**Purpose:** answer "what are all the moving pieces of rev01?" in 60 seconds.
...
**Layout hint:** strict left-to-right flow. Validator drawn as a *gate* with a lock icon — anything that fails fails loudly.
...
- One large heading at the top: "rev01 — security pass"
...
- "13 env secrets"
- "Routes: `rev01.aayushman.dev` + `*.rev01.aayushman.dev`"
