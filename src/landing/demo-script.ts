...
//
// Client-side script for the landing page demo. Drives the miniature canvas
// in the hero preview panel, the synced agent log feed, scroll-reveal
// animations, and stat-line count-up.
//
...
export const LANDING_DEMO_SRC = String.raw`(function() {
  var ELS = [
    ...
    ['hero-orb', 'demo-shape-circle','top:14%;right:10%;width:40px;height:40px;',                                   ''],
  ...
  var STEPS = [
    [300,   'show', 'nav',                                          '+section', 'nav'],
    [500,   'show', 'logo',                                         '+text',    '"rev01"'],
    [800,   'show', 'nav-lnk',                                      '+action',  '"Features" ghost'],
    [1100,  'show', 'nav-cta',                                      '+action',  '"Get started" solid'],
    [1600,  'show', 'hero-bg',                                      '+section', 'hero'],
    [2000,  'type', 'hero-h|Ship a site that feels lived-in.',      '+heading', '"Ship a site..."'],
    [3400,  'show', 'hero-p',                                       '+text',    'body paragraph'],
    [3900,  'show', 'hero-btn',                                     '+action',  '"Start editing"'],
    [4300,  'show', 'hero-orb',                                     '+shape',   'circle'],
    [4800,  'show', 'f1,f1-dot,f1-txt',                             '+section', 'features'],
    [5100,  'show', 'f2,f2-dot,f2-txt',                             '+container', 'card x2'],
    [5400,  'show', 'f3,f3-dot,f3-txt',                             '+container', 'card x3'],
    [6000,  'show', 'cta-h',                                        '+heading', '"Publish when..."'],
    [6400,  'show', 'cta-b1',                                       '+action',  '"Open editor" pill'],
    [6700,  'show', 'cta-b2',                                       null,       null],
    [8500,  'kit',  'orange-editorial',                              'setTheme', 'orange-editorial'],
    [10000, 'kit',  'blue-saas',                                     'setTheme', 'blue-saas'],
    [11500, 'kit',  'green-organic',                                 'setTheme', 'green-organic'],
    [13000, 'hide', '',                                              null,       null]
  ];

  var CYCLE = 14500;
  var canvas, feed, els = {}, timers = [];
