      ...
      const overlayClass =
        presentation === 'fullscreen-menu'
          ...
          : presentation === 'lightbox'
            ? `opencanvas-overlay opencanvas-overlay--lightbox opencanvas-overlay--chrome-${escapeAttr(chrome)}`
            : presentation === 'command-palette'
              ? `opencanvas-overlay opencanvas-overlay--command-palette opencanvas-overlay--chrome-${escapeAttr(chrome)}`
              : presentation === 'product-tour'
                ? `opencanvas-overlay opencanvas-overlay--product-tour opencanvas-overlay--chrome-${escapeAttr(chrome)}`
