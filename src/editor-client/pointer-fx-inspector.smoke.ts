...
assert(
  inspectorSrc.includes("buildToggleField('Enable pointer FX'"),
  'Enable pointer FX must use the shared toggle-pill DOM, not a raw checkbox field',
);
...
assert(
  inspectorSrc.includes("buildToggleField('Inertia'"),
  'Inertia must use the shared toggle-pill DOM, not a raw checkbox field',
);
